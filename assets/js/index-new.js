...
const istTime = document.getElementById("timeSpan");
// istTime.textContent = formattedTime;
...
function initTimeZone() {
    ...
    if (document.querySelector("#timeSpan")) {
        function updateISTTime() {
            ...
            const istTime = timeFormatter.format(date);
    
            document.querySelector("#timeSpan").textContent = istTime;
        }
    
        updateISTTime();
        setInterval(updateISTTime, 60000); // Update every minute
    }
